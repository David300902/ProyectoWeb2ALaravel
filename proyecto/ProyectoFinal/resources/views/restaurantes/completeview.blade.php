...
<script>
      ...
      app.controller("CriticoInfoController", ($scope, $http)=>{
        ...
        $scope.getCritico = function(){
            ...
            .then(
                res => {
                    $scope.restaurante = res.data
                    $http
                    .get(`/articulosbyrestaurante/` + id)
                    .then(
                        res2 => {
...
<section class="bg-light">
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body p-1-9 p-sm-2-3 p-md-6 p-lg-7">
                        <div class="row align-items-center">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <img src="@{{restaurante.foto}}" width="600px" alt="...">
                            </div>
                            <div class="col-lg-6 px-xl-10">
                                <div class="bg-secondary d-lg-inline-block py-1-9 px-1-9 px-sm-6 mb-1-9 rounded">
                                    <h3 class="h2 text-white mb-0">@{{restaurante.name}}</h3>
                                    <span class="text-primary">Restaurante</span>
                                </div>
                                <ul class="list-unstyled mb-1-9">
                                    <li class="mb-2 mb-xl-3 display-28"><span class="display-26 text-secondary me-2 font-weight-600">Tipo:</span>Restaurante</li>
                                </ul>
            ...
            <div class="col-lg-12 mb-4 mb-sm-5">
                <div>
                    <span class="section-title text-primary mb-3 mb-sm-4">Sobre El Restaurente</span>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12 mb-4 mb-sm-5">
                        ...
                        <div >
                            <h1>Criticas en @{{restaurante.name}}</h1>
                        </div>
                        <div class="card text-center" ng-repeat="r in articulos">
